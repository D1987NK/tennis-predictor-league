...
import { AddPointsForm } from "@/components/admin/add-points-form";
...
export default async function AdminUsersPage() {
  ...
  const adjustableUsers = users
    .filter((u) => u.role === "USER")
    .map((u) => ({ id: u.id, username: u.username, name: `${u.firstName} ${u.lastName}` }));

  return (
    <div className="space-y-6 animate-fade-in">
      <AddPointsForm users={adjustableUsers} />
      <Card>
        <CardHeader>
